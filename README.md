...
## Sobre o projeto:
Exemplo de aplicação de Design Patterns na prática em um projeto WebAPI .NET Core 3.1 utilizada na palestra "Aplicando design patterns na prática com C#" dirigida por Víctor Fructuoso, e posteriormente no bootcamp "Decola Dev 2021" da Avanade 🚀.
O projeto tem como objetivo entender a aplicação de design patterns, mostrando o beneficio de seu uso, e juntamente com as aulas do bootcamp, trouxeram a teoria e prática de como aplicar esses conceitos num projeto real.
